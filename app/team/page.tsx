...
export default function BoardOfDirectorsPage() {
  ...
  return (
    <main className="w-full bg-white">
      ...
      {/* HERO */}
 <section className="relative w-full h-[350px] md:h-[420px] bg-gradient-to-br from-[#1E3A8A] via-[#1D4ED8] to-[#0f3d6a] text-white flex items-center px-6 md:px-16">
  ...
  <div className="max-w-4xl">
    ...
    <div className="absolute top-6 left-6 text-white text-sm">
      ...
      <span className="text-white/70">Our Team</span>
    </div>
    ...
    {/* DESCRIPTION */}
    <p className="mt-6 text-sm md:text-base text-white/80 max-w-2xl leading-relaxed">
      Our leadership team brings together global expertise, strategic vision,
      and a commitment to excellence—driving innovation and sustainable growth
      across the RSH Group.
    </p>
