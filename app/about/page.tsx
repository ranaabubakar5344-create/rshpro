...
<section className="bg-[#f8fafc] py-24 px-6 md:px-16">
  ...
  <div className="text-center mb-16">
    <h2 className="text-3xl md:text-4xl font-extrabold text-[#0f1f52]">
      Leadership Team
    </h2>
    <div className="w-20 h-[3px] bg-amber-400 mx-auto mt-4 rounded-full" />
  </div>
...
{[
  {
    name: "Dr. Raja Sajjad Hussain",
    role: "Founder & Strategic Lead",
    img: "/dr-raja-sajjad-DVFf37DC.jpg",
    desc: "Driving global academic partnerships and institutional growth across international education networks."
  },
  {
    name: "Hassan Sajjad",
    role: "Director Operations",
    img: "/hassan-sajjad-DjtF74hH.jpg",
    desc: "Overseeing multi-regional operations with a focus on efficiency, compliance, and performance."
  },
  {
    name: "Dr. Rushna Maryam",
    role: "Director Business Development",
    img: "/dr-rushna-maryam-CcNKD-sA.jpg",
    desc: "Leading global partnerships and expansion strategies across key education markets."
  },
  {
    name: "Mrs. Lubna Sajjad",
    role: "Senior Leadership",
    img: "/mrs-lubna-sajjad-DUJNamKy.jpg",
    desc: "Supporting strategic development and academic excellence across RSH institutions."
  },
].map((item, i) => (
  ...
  >
    ...
    <div className="relative w-24 h-24 mx-auto mb-5">
      <Image
        ...
        alt={item.name}
        fill
        className="object-cover rounded-full border-4 border-white shadow-[0_0_0_3px_rgba(230,180,34,0.3)] group-hover:scale-105 transition"
      />
    </div>
    ...
    <p className="text-xs uppercase tracking-widest text-amber-500 mt-1">
      {item.role}
    </p>
...
<section className="py-24 px-6 md:px-16 bg-white">
  ...
  {/* HEADING */}
  <div className="text-center mb-16">
    <p className="uppercase tracking-[0.25em] text-xs text-[#3A5FCE] mb-3">
      Global Network
    </p>

    <h2 className="text-3xl md:text-4xl font-semibold text-[#0f1f52]">
      Our Global Presence
    </h2>

    <p className="text-gray-500 mt-4 max-w-2xl mx-auto text-sm md:text-base leading-relaxed">
      RSH Group operates across key international regions, delivering
      high-quality education through strategic partnerships and globally
